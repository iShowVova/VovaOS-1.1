...
title BIOS Setup Utility HELLO BIOS
mode con: lines=42 cols=119

:cfg
	sound play VovaOS\Sounds\Bios.wav
	set "version=1.1.0"
	set "kernel_version=0.2.0"
	cls
	
	< VovaOS\System32\BIOS\Config\cfg.set (
	set /p null=
	set /p st=
	set /p nd=
	set /p rd=
...
:BIOS.Main
	...
	insertbmp /p:"VovaOS\System32\BIOS\Wallpapers\BIOSSU.bmp" /x:0 /y:0 /z:100
	insertbmp /p:"VovaOS\System32\BIOS\Wallpapers\upbarinfo.bmp" /x:0 /y:489 /z:100
	insertbmp /p:"VovaOS\System32\BIOS\Wallpapers\upbar.bmp" /x:0 /y:21 /z:100
...
:BIOS.Reset
	...
	insertbmp /p:"VovaOS\System32\BIOS\Wallpapers\Blue.bmp" /x:350 /y:180 /z:100
...
:BIOS.SysInfo
	...
	echo Г Windows:                                                                            Г                              Г
	echo Г                                                                                     Г                              Г
	echo Г Batch OS:   Vova Os 1.1  	                                                       Г                              Г
	echo Г                                                                                     Г                              Г
	echo Г                                                                                     Г                              Г
	echo Г                                                                                     Г                              Г
	echo Г                                                                                     Г                              Г
